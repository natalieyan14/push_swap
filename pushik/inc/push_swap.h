...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/20 01:49:46 by natalieyan        #+#    #+#             */
/*   Updated: 2025/07/25 20:51:16 by natalieyan       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					rotate_before_push(t_stack **a, int count_largest,
							int size);
void					rotate_after_push(t_stack **a, int count_largest,
							int size);
